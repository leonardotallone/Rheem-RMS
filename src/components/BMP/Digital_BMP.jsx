...
const Digital_BMP = () => {
  ...
  const [ingresada] = useState(true);
  const [enpicking] = useState(true);
  const [completa] = useState(true);
  const [conFaltante] = useState(true);
  const [sinEmitir] = useState(true);
        ...
        <div className="col s12 m12 l12 title-banner z-depth-2">
          <div className="container">
            ...
            <div className="col s7 m8 l8 no-margin">
              ...
              <p className="font-subtitle-plan-list">Planes Digitales</p>
            </div>
    ...
    <div className="row ">
     ...
     <div className="col s6 m5 l2 center-align no-margin">
        <div className="display-box-bmp-ingresada z-depth-1">
    ...
    <div className="row ">
     ...
     <a href="/production-line-cp">
     <div className="col s6 m5 l2 center-align no-margin">
        <div className="display-box-bmp-picking z-depth-1">
  
            <p className="text-inside-box">EN PICKING</p> 
        </div>
     </div>
     </a> 
     <div className="col s6 m5 l3 center-align no-margin">
    ...
    <div className="row ">
     ...
     <div className="col s6 m5 l2 center-align no-margin">
        ...
        "display-box-bmp-completa z-depth-1">
            <p className="text-inside-box">ARMADA COMPLETA</p> 
        </div>
     </div>
     </a> 
     <div className="col s6 m5 l3 center-align no-margin">
    ...
    <div className="row ">
     ...
     <div className="col s6 m5 l2 center-align no-margin">
        ...
        "display-box-bmp-incompleta z-depth-1">
            ...
            <p className="text-inside-box">CON FALTANTE</p> 
        </div>
     </div>
     </a> 
     <div className="col s6 m5 l3 center-align no-margin">
    ...
    <div className="row ">
     ...
     <div className="col s6 m5 l2 center-align no-margin">
       ...
       "display-box-components zdepth-1">
            <p className="text-inside-box">SIN EMITIR</p> 
        </div>
     </div>
     </a> 
     <div className="col s6 m5 l3 center-align no-margin">
