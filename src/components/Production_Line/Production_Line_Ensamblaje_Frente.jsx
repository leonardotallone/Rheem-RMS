...
const Production_Line_Ensamblaje_Frente = () => {
    ...
    const [frenteCodeDisplay, setFrenteCodeDisplay] = useState();
    ...
    const handleSubmitCodesDisplay = (values) => {
      ...
      setChasis(true)
      setFrenteCodeDisplay(values.frenteCode)
      if(values.chasisCode && values.frenteCode){
        setHabilitar(true)
      }
    }
  ...
  return (
    <>
        ...
        <div className="col s12 m12 l12 title-banner z-depth-2">
          <div className="container">
            ...
            <div className="col l9">
                ...
                <p className="subtitle-production-line in-line"> &nbsp;(Ensamblaje Chasis-Frente)</p>
              ...
              <div className="display-box-fine-tunning-scancode z-depth-1">
                  <Formik initialValues={{ chasisCode:'', frenteCode:''}} 
                  ...
                  <div className="col s9 m10 push-m1 l10 push-l1 ">
                    ...
                    <div className="col s9 m10 push-m1 l10 push-l1 ">
                    <div className="input-field">
                      <label className="label-text-scan" htmlFor="chasis">Código de Frente</label>
                        <Field name="frenteCode" type="text" />
                    <div className="warning-inputs-scan right"><ErrorMessage name="codigoDeChasis" /></div>
                    </div>
                </div>          
                  }
      ...
      <Formik
              initialValues={{ chasisCode:{chasisCodeDisplay}, frenteCode:{frenteCodeDisplay}}}
      ...
      <div className="container">
        ...
        <div className="row">
            ...
            <div className="col l6">
                <p className="display-box-title">Código de Frente</p>
                <div className="ensamblaje-box z-depth-1 center">
                  <p className="ensamblaje-text">{frenteCodeDisplay}</p>
                </div>
            </div>
        </div>
...
export default Production_Line_Ensamblaje_Frente;
