...
import Image_Profile2 from "../../../assets/Image_Profile2.jpg"

// import { ReactComponent as Unlock } from "../../../assets/icons/unlock.svg"


const Administrador_De_Cuentas = () => {
        ...
        <ul className="left-dropdown hide-on-med-and-down">
          <li>
            <a className="dropdown-trigger nav-font valign-wrapper" href="null" data-target="dropdown">
              <i className="material-symbols-outlined black-text valign-wrapper left">group</i>
              Usuarios</a>
            <ul id="dropdown" className="dropdown-content  z-depth-2">
              <li> <NavLink to="/create-user" className="dropdown-font">Crear Usuario</NavLink></li>
...
{/*******************  NAVBAR OPTIONS ****************************/}
          ...
          <ul className="right hide-on-med-and-down ">
            ...
            <li className="nav-font-rms">Administrador de Cuentas</li>
            <li><NavLink className="nav-font"to="">|</NavLink> </li>
          <li className="nav-font">{user.name + " " + user.last_name}</li>
          <li>
            <a href=""><i onClick={logout} className="material-icons black-text">logout</i></a>
          </li>
             <li><NavLink to="/userprofile" ><img onMouseOver={handleMouseOver} onMouseOut={handleMouseOut} href="/userprofile"src={Image_Profile2} alt="" className="avatar-nav btn-floating"></img> </NavLink></li>
        </ul>
             {isHovering && (
...
{/**********************************************  SIDENAV DROPDOWN ******************************************************/}
        ...
        <li>
            <a className="dropdown-trigger nav-font valign-wrapper" href="null" data-target="dropdown-sidenav"><i className="material-symbols-outlined black-text valign-wrapper left">group</i>Usuarios</a>
            <ul id="dropdown-sidenav" className="dropdown-content-side">
              <li> <NavLink to="/create-user" className="dropdown-font sidenav-close">Crear Usuario</NavLink></li>
              <li className="divider"></li>
...
{/**********************************************  SIDENAV OPTIONS ******************************************************/}
          ...
          <li>
           ...
           <li><NavLink to="/userprofile"><img href="/userprofile"src={Image_Profile2} alt=""className="btn btn-floating avatar-nav"></img></NavLink></li>
        </ul>
      </ul>
    </>
  );
};
export default Administrador_De_Cuentas;
