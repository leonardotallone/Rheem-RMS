...
import { ReactComponent as Icono } from '../../../assets/icons/metrics.svg';
        ...
        <ul className="left-dropdown hide-on-med-and-down">
          <li>
            ...
            <ul id="dropdown" className="dropdown-content z-depth-2">
              ...
              <li> <NavLink to="/qa-labs-sample-preview" className="dropdown-font">Avance de Muestras</NavLink></li>   
              <li className="divider"></li>
              <li> <NavLink to="/qa-labs-counter-sample-preview" className="dropdown-font">Avance de Contramuestras</NavLink></li> 
            </ul>
          </li>
...
{/*******************  NAVBAR OPTIONS ****************************/}
          ...
          <li className="nav-font-rms">Gerencia</li>
          <li><NavLink className="nav-font"to="">|</NavLink> </li>
...
{/**********************************************  SIDENAV DROPDOWN ******************************************************/}
        ...
        <li>
            <a className="dropdown-trigger nav-font valign-wrapper" href="null" data-target="dropdown-sidenav"><Icono/>Métricas</a>
            <ul id="dropdown-sidenav" className="dropdown-content-side">
              ...
              <li className="divider"></li>
              <li> <NavLink to="/qa-labs-sample-preview" className="dropdown-font sidenav-close">Avance Muestras</NavLink></li>
              <li className="divider"></li>
              <li> <NavLink to="/qa-labs-counter-sample-preview" className="dropdown-font sidenav-close">Avance Contramuestras</NavLink></li>
            </ul>
          </li>
...
{/**********************************************  SIDENAV OPTIONS ******************************************************/}
          ...
          <li className="divider"></li>
          <li> <NavLink className="nav-font-rms">Gerencia</NavLink></li>
          <li className="divider"></li>
