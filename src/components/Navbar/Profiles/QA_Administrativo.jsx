        ...
        <ul className="left-dropdown hide-on-med-and-down">
          <li>
            <a className="dropdown-trigger nav-font valign-wrapper" href="null" data-target="dropdownProcesos">
              <i className="material-symbols-outlined black-text valign-wrapper left">rebase</i>
              Procesos QA</a>
            <ul id="dropdownProcesos" className="dropdown-content z-depth-2">
              <li> <NavLink to="/qa-admin-test-sheet-set-values" className="dropdown-font">Seteo Planilla Ensayo QA</NavLink></li>
              ...
              <li className="divider"></li>
              <li> <NavLink to="/qa-admin-traceability-history" className="dropdown-font">Historial de Trazabilidad</NavLink></li> 
              <li className="divider"></li>
          ...
          <li>
            <a className="dropdown-trigger nav-font valign-wrapper" href="null" data-target="dropdownReprocesos">
              <i className="material-symbols-outlined black-text valign-wrapper left">cycle</i>Reprocesos QA</a>
            <ul id="dropdownReprocesos" className="dropdown-content z-depth-2">
              <li> <NavLink to="/qa-admin-rejected-batchs-list" className="dropdown-font">Lotes Rechazados</NavLink></li>
              <li className="divider"></li>
              <li> <NavLink to="/qa-admin-validate-reprocess-qa" className="dropdown-font">Validación de Reprocesos QA</NavLink></li> 
              <li className="divider"></li>
              <li> <NavLink to="/qa-admin-validate-reprocess-r&d" className="dropdown-font">Validación de Reprocesos R&D</NavLink></li> 
              <li className="divider"></li>
              <li> <NavLink to="/qa-admin-validate-at" className="dropdown-font">Validación por AT</NavLink></li>   
            </ul>
          </li>
...
{/*******************  NAVBAR OPTIONS ****************************/}
          ...
          <li className="nav-font-rms">QA Administrativo</li>
          <li><NavLink className="nav-font"to="">|</NavLink> </li>
...
{/**********************************************  SIDENAV DROPDOWN ******************************************************/}
        ...
        <li>
            ...
            <ul id="dropdownProcesosSide" className="dropdown-content-side">
              <li> <NavLink to="/qa-admin-test-sheet-set-values" className="dropdown-font sidenav-close">Seteo Planilla Ensayo QA</NavLink></li>
              <li className="divider"></li>
              ...
              <li className="divider"></li>
              <li> <NavLink to="/qa-admin-traceability-history" className="dropdown-font sidenav-close">Historial de Trazabilidad</NavLink></li> 
              <li className="divider"></li>
          ...
          <li>
            ...
            <ul id="dropdownReprocesosSide" className="dropdown-content-side">
              <li> <NavLink to="/qa-admin-rejected-batchs-list" className="dropdown-font sidenav-close">Lotes Rechazados</NavLink></li>
              <li className="divider"></li>
              <li> <NavLink to="/qa-admin-validate-reprocess-qa" className="dropdown-font sidenav-close">Validación de Reprocesos QA</NavLink></li> 
              <li className="divider"></li>
              <li> <NavLink to="/qa-admin-validate-reprocess-r&d" className="dropdown-font sidenav-close">Validación de Reprocesos R&D</NavLink></li> 
              <li className="divider"></li>
              <li> <NavLink to="/qa-admin-validate-at" className="dropdown-font sidenav-close">Validación por AT</NavLink></li>   
            </ul>
          </li>
...
{/**********************************************  SIDENAV OPTIONS ******************************************************/}
          ...
          <li className="divider"></li>
          <li> <NavLink className="nav-font-rms">Administrador de Cuentas</NavLink></li>
          <li className="divider"></li>
...
export default QA_Administrativo;
