...
const Validate_Reprocess_RandD = () => {
...
// }
        ...
        <div className="col s12 m12 l12 title-banner z-depth-2">
          <div className="container">
            ...
            <div className="col s7 m8 l8 no-margin">
              <p className="font-title-plan-list">Validación de Reproceso por R&D</p>
    ...
    <div className="row display-box-plan z-depth-1">
            ...
            <div className="col s12 m12 l3">
                <p className="last-modification">DATO:</p>
                <p className="last-modification-date">DATO</p>
            </div>
            <div className="col s12 m12 l3">
            ...
            <div className="col s12 m12 l2">
               <p className="state-plan">TERMINADO</p>
            </div>
            <div className="col s12 m12 l2">
  ...
  export default Validate_Reprocess_RandD;